...
\begin{itemize}
    \item \textbf{整体框架}：训练侧 $\times$ 推理侧二因素析因、合法性约束排除 2 组后的 10 组有效实验矩阵、训练-评测两级流水线、四类训练与三类推理在 \texttt{chat messages} 层面的输入骨架（4.1 节（1a）（1b））、以及第五章三类主要对照（主效应、交互效应、few-shot 一致性）的取数口径；
