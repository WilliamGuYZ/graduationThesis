...
\paragraph{（5）结果落盘}
评测结束后，除控制台打印三档 pass@k 外，还会将 \texttt{timestamp / num\_problems / num\_samples / temperature / timeout / pass\_at\_k / original\_solution\_pass\_rate} 汇总为一份 JSON 落入 \texttt{evaluation/results/eval\_base\_passk.json}，即 H1 的最终产物，供第五章主效应与交互效应的差分计算直接读取。